...
from .helpers import MSG_ORDEN_SIN_ITEMS, orden_tiene_servicios_o_repuestos
...
def obtener_estadisticas_dashboard(
    ...
    return {
        ...
        "periodo_facturado": (
            {"fecha_desde": fecha_desde, "fecha_hasta": fecha_hasta} if (fecha_desde or fecha_hasta) else None
        ),
    }
