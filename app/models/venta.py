...
from sqlalchemy import DECIMAL, TIMESTAMP, Boolean, Column, DateTime, Enum, ForeignKey, Integer, Text
...
class Venta(Base):
    ...
    )  # Comisiones: quien cobra por la venta
    ...
    id_orden = Column(
        Integer, ForeignKey("ordenes_trabajo.id"), nullable=True, index=True
