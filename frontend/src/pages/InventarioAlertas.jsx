...
export default function InventarioAlertas() {
  ...
  return (
    <div>
      <Link
        to="/inventario"
        className="inline-flex items-center gap-2 min-h-[44px] px-4 py-2.5 bg-slate-100 border border-slate-300 text-slate-700 font-medium rounded-lg hover:bg-slate-200 hover:border-slate-400 transition-colors shadow-sm mb-6 touch-manipulation"
      >
        ← Volver a Inventario
      </Link>
      <h1 className="text-xl sm:text-2xl font-bold text-slate-800 mb-4 sm:mb-6">Alertas de inventario</h1>
